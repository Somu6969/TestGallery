const repoURL = 'https://api.github.com/repos/Somu6969/Gallery/contents/'; // Replace with your GitHub repo details
        ...
        data.forEach(file => {
            if (file.name.endsWith('.jpg') || file.name.endsWith('.png') || file.name.endsWith(".ARW")) {
                if (file.name.endsWith(".jpg") || file.name.endsWith(".png")) {
                    ...
                    a.href = `https://raw.githubusercontent.com/Somu6969/Gallery/main/${baseName}`;
